...
## Quick note
This repo is forked from [`react-custom-scrollbars-2`](https://github.com/RobPethick/react-custom-scrollbars-2) with [PR 32](https://github.com/RobPethick/react-custom-scrollbars-2/pull/32)
